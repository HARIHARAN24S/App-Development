...
export default function Home() {
  ...
  const contentData = [
    { title: 'Lifestyle', img: 'lifestyle.jpg', link: '/lifestyle' },
    { title: 'Love', img: 'lovi.jpg', link: '/love' },
    { title: 'Crime', img: 'crimy.jpg', link: '/crime' },
    { title: 'Mythology', img: 'MYTHY.jpg', link: '/mythology' },
    { title: 'Sports', img: ' gamy.jpg', link: '/sports' },
    { title: 'Comedy', img: 'comdy.jpg', link: '/comedy' },
    { title: 'Horror', img: 'hory.jpg', link: '/horror' },
    { title: 'History', img: 'history.jpg', link: '/history' },
    { title: 'Kids', img: 'KIDY.jpg', link: '/kids' },
];
