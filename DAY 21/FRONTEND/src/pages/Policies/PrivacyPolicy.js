...
<p><strong>Application</strong> refers to ReadOut, the software program provided by the Company.</p>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to STORY TELLING, SRI KRISHNA COLLEGE OF TECHNOLOGY,KOVAIPUDUR,COIMBATORE.</p>
...
<br></br> <br></br> <br></br> <br></br>
      ...
      <div className="footer"><Link to="/terms"><div className="hlo">Terms & Conditions</div></Link>
      <Link to="/policies"><div className="bro">Privacy Policy</div></Link>
        ...
        <div className="cry">Copyright © 2023. All rights reserved</div></Link>
      </div>
    </div>
  );
}
